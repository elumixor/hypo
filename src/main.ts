...
const cubeMat = new THREE.MeshStandardMaterial({ color: '#ff5666', roughness: 0.4, metalness: 0.1 });
...
const title = new Text({ text: 'HYPO PROTOTYPE', style: { fill: '#fff', fontSize: 18, letterSpacing: 2 } });
title.x = 12;
title.y = 10;
ui.addChild(title);
...
let active = false; let lx = 0; let ly = 0;
addEventListener('pointerdown', (e: PointerEvent) => { active = true; lx = e.clientX; ly = e.clientY; });
